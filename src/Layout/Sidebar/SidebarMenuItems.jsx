...
import { IoMdHeart, IoMdHome, IoMdSettings } from "react-icons/io";
import { FaShoppingBag, FaShoppingCart, FaUsers, FaUser, FaBox ,FaDesktop} from "react-icons/fa";
          ...
          {Item.Items.map((menuItem, i) => (
            <li className="sidebar-list" key={i}>
              {menuItem.type === "sub" ? (
                ...
                >
                  {menuItem.icon === "heart" && <IoMdHeart className="icon" />}
                  {menuItem.icon === "home" && <IoMdHome className="icon" />}
                  {menuItem.icon === "settings" && (
                    <IoMdSettings className="icon" />
                  )}
                  {menuItem.icon === "order" && <FaShoppingCart className="icon" />}
                  {menuItem.icon === "product" && < FaShoppingBag className="icon" />}
                  {menuItem.icon === "customer" && (
                    <FaUsers className="icon" />
                  )}
                   {menuItem.icon === "profile" && (
                    <FaUsers className="icon" />
                  )}
                  {menuItem.icon === "inventary" && (
